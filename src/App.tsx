    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="max-w-md w-full bg-card border border-border p-8 rounded-2xl text-center space-y-4">
          <div className="w-16 h-16 bg-primary/10 text-primary rounded-[1.25rem] flex items-center justify-center mx-auto mb-4">
            <Box className="w-8 h-8" />
          </div>
          <h1 className="text-2xl font-black tracking-tight">Abilities AI</h1>
          <p className="text-muted-foreground text-sm">
            Please add your <strong>Clerk Publishable Key</strong> to the Secrets panel in AI Studio to unlock your potential.
          </p>
